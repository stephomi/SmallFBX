...
Property::Property(Property &&v) noexcept : m_type(v.m_type), m_scalar(v.m_scalar), m_data(std::move(v.m_data)) {}
...
template <class T> static inline void Assign(RawVector<char> &dst, const span<T> &v) {
    size_t s = v.size_bytes();
    dst.resize(s);
    dst.assign((char *)v.data(), s);
}

template <> void Property::assign(boolean v) {
    m_type = PropertyType::Bool;
    m_scalar.b = v;
}
template <> void Property::assign(bool v) {
    m_type = PropertyType::Bool;
    m_scalar.b = v;
}
template <> void Property::assign(int16 v) {
    m_type = PropertyType::Int16;
    m_scalar.i16 = v;
}
template <> void Property::assign(int32 v) {
    m_type = PropertyType::Int32;
    m_scalar.i32 = v;
}
template <> void Property::assign(int64 v) {
    m_type = PropertyType::Int64;
    m_scalar.i64 = v;
}
template <> void Property::assign(float32 v) {
    m_type = PropertyType::Float32;
    m_scalar.f32 = v;
}
template <> void Property::assign(float64 v) {
    m_type = PropertyType::Float64;
    m_scalar.f64 = v;
}

template <> void Property::assign(double2 v) {
    m_type = PropertyType::Float64Array;
    Assign(m_data, make_span(v));
}
template <> void Property::assign(double3 v) {
    m_type = PropertyType::Float64Array;
    Assign(m_data, make_span(v));
}
template <> void Property::assign(double4 v) {
    m_type = PropertyType::Float64Array;
    Assign(m_data, make_span(v));
}
template <> void Property::assign(double4x4 v) {
    m_type = PropertyType::Float64Array;
    Assign(m_data, make_span(v));
}

template <> void Property::assign(span<uint8_t> v) {
    m_type = PropertyType::Blob;
    Assign(m_data, v);
}
template <> void Property::assign(span<boolean> v) {
    m_type = PropertyType::BoolArray;
    Assign(m_data, v);
}
template <> void Property::assign(span<int16> v) {
    m_type = PropertyType::Int16Array;
    Assign(m_data, v);
}
template <> void Property::assign(span<int32> v) {
    m_type = PropertyType::Int32Array;
    Assign(m_data, v);
}
template <> void Property::assign(span<int64> v) {
    m_type = PropertyType::Int64Array;
    Assign(m_data, v);
}
template <> void Property::assign(span<float32> v) {
    m_type = PropertyType::Float32Array;
    Assign(m_data, v);
}
template <> void Property::assign(span<float64> v) {
    m_type = PropertyType::Float64Array;
    Assign(m_data, v);
}
...
bool Property::isArray() const { return (char)m_type > 'Z'; }

uint64_t Property::getArraySize() const { return m_data.size() / SizeOfElement(m_type); }

template <> boolean Property::getValue() const {
    convert(PropertyType::Bool);
    return m_scalar.b;
}
template <> bool Property::getValue() const {
    convert(PropertyType::Bool);
    return m_scalar.b;
}
template <> int16 Property::getValue() const {
    convert(PropertyType::Int16);
    return m_scalar.i16;
}
template <> int32 Property::getValue() const {
    convert(PropertyType::Int32);
    return m_scalar.i32;
}
template <> int64 Property::getValue() const {
    convert(PropertyType::Int64);
    return m_scalar.i64;
}
template <> float32 Property::getValue() const {
    convert(PropertyType::Float32);
    return m_scalar.f32;
}
...
template <> span<int16> Property::getArray() const {
    convert(PropertyType::Int16Array);
    return make_span((int16 *)m_data.data(), getArraySize());
}
template <> span<int32> Property::getArray() const {
    convert(PropertyType::Int32Array);
    return make_span((int32 *)m_data.data(), getArraySize());
}
template <> span<int64> Property::getArray() const {
    convert(PropertyType::Int64Array);
    return make_span((int64 *)m_data.data(), getArraySize());
}
template <> span<float32> Property::getArray() const {
    convert(PropertyType::Float32Array);
    return make_span((float32 *)m_data.data(), getArraySize());
}
...
template <class T> static inline void Convert(RawVector<char> &data) {
...
bool Property::convert(PropertyType t) const {
    ...
    if (m_type == PropertyType::Float64) {
        switch (t) {
        case PropertyType::Bool:
            m_scalar.b = m_scalar.f64 == 0.0;
            ret = true;
            break;
        case PropertyType::Int16:
            m_scalar.i16 = (int16)m_scalar.f64;
            ret = true;
            break;
        case PropertyType::Int32:
            m_scalar.i32 = (int32)m_scalar.f64;
            ret = true;
            break;
        case PropertyType::Int64:
            m_scalar.i64 = (int64)m_scalar.f64;
            ret = true;
            break;
        case PropertyType::Float32:
            m_scalar.f32 = (float32)m_scalar.f64;
            ret = true;
            break;
        default:
            break;
        ...
        switch (t) {
        case PropertyType::Int16Array:
            Convert<int16>(m_data);
            ret = true;
            break;
        case PropertyType::Int32Array:
            Convert<int32>(m_data);
            ret = true;
            break;
        case PropertyType::Int64Array:
            Convert<int64>(m_data);
            ret = true;
            break;
        case PropertyType::Float32Array:
            Convert<float32>(m_data);
            ret = true;
            break;
        default:
            break;
...
void Property::toString(std::string &dst, int depth) const {
    if (isArray()) {
        ...
        switch (m_type) {
        case PropertyType::Int16Array:
            do_append(getArray<int16>());
            break;
        case PropertyType::Int32Array:
            do_append(getArray<int32>());
            break;
        case PropertyType::Int64Array:
            do_append(getArray<int64>());
            break;
        case PropertyType::Float32Array:
            do_append(getArray<float32>());
            break;
        case PropertyType::Float64Array:
            do_append(getArray<float64>());
            break;
        default:
            break;
        }
        ...
        switch (m_type) {
        case PropertyType::Bool:
            append(dst, getValue<boolean>());
            break;
        case PropertyType::Int16:
            append(dst, getValue<int16>());
            break;
        case PropertyType::Int32:
            append(dst, getValue<int32>());
            break;
        case PropertyType::Int64:
            append(dst, getValue<int64>());
            break;
        case PropertyType::Float32:
            append(dst, getValue<float32>());
            break;
        case PropertyType::Float64:
            append(dst, getValue<float64>());
            break;
